...
The data spans exactly 5 years, from **January 1, 2020, to December 31, 2024**, resulting in approximately 1,827 daily records. It captures various atmospheric conditions, making it highly suitable for our target task: predicting the Average Relative Humidity (`RH_avg`).
